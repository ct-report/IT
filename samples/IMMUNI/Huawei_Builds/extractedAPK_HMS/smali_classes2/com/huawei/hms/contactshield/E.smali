.class public Lcom/huawei/hms/contactshield/E;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Lcom/huawei/hms/contactshield/contact/request/GetContactSketchRequest;",
...
# direct methods
.method public constructor <init>(Lcom/huawei/hms/contactshield/contact/request/GetContactSketchRequest;)V
    .locals 1

    const-string v0, "nearby.getContactSketch"
...
.method protected bridge synthetic a(Lcom/huawei/hms/common/internal/AnyClient;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lcom/huawei/hmf/tasks/TaskCompletionSource;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/huawei/hms/contactshield/E;->a(Lcom/huawei/hms/contactshield/w;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lcom/huawei/hmf/tasks/TaskCompletionSource;)V
...
.method protected a(Lcom/huawei/hms/contactshield/w;Lcom/huawei/hms/common/internal/ResponseErrorCode;Ljava/lang/String;Lcom/huawei/hmf/tasks/TaskCompletionSource;)V
    ...
    const-class p1, Lcom/huawei/hms/contactshield/contact/response/GetContactSketchResponse;

    invoke-static {p3, p1}, Lcom/huawei/hms/contactshield/m;->a(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/huawei/hms/contactshield/contact/response/GetContactSketchResponse;

    if-nez p1, :cond_0

    new-instance p1, Lcom/huawei/hms/contactshield/ContactSketch$Builder;

    invoke-direct {p1}, Lcom/huawei/hms/contactshield/ContactSketch$Builder;-><init>()V

    invoke-virtual {p1}, Lcom/huawei/hms/contactshield/ContactSketch$Builder;->build()Lcom/huawei/hms/contactshield/ContactSketch;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/huawei/hms/contactshield/contact/response/GetContactSketchResponse;->a()Lcom/huawei/hms/contactshield/ContactSketch;

    move-result-object p1

    invoke-virtual {p4, p1}, Lcom/huawei/hmf/tasks/TaskCompletionSource;->setResult(Ljava/lang/Object;)V

    const-string p1, "GetContactSketchTaskApiCall"

    const-string p2, "ContactShield contactsketch getted"
