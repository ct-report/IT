.class final Lcom/huawei/hms/framework/network/grs/c/f;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/huawei/hms/framework/network/grs/c/g;->a(Ljava/util/ArrayList;JLorg/json/JSONArray;Landroid/content/Context;)V
.end annotation
...
.method constructor <init>(JLandroid/content/Context;Ljava/util/ArrayList;Lorg/json/JSONArray;)V
    ...
    iput-wide p1, p0, Lcom/huawei/hms/framework/network/grs/c/f;->a:J

    iput-object p3, p0, Lcom/huawei/hms/framework/network/grs/c/f;->b:Landroid/content/Context;

    iput-object p4, p0, Lcom/huawei/hms/framework/network/grs/c/f;->c:Ljava/util/ArrayList;

    iput-object p5, p0, Lcom/huawei/hms/framework/network/grs/c/f;->d:Lorg/json/JSONArray;
...
.method public run()V
    ...
    iget-wide v1, p0, Lcom/huawei/hms/framework/network/grs/c/f;->a:J
    ...
    iget-object v1, p0, Lcom/huawei/hms/framework/network/grs/c/f;->b:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/huawei/hms/framework/network/grs/c/f;->c:Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcom/huawei/hms/framework/network/grs/c/g;->a(Lcom/huawei/hms/framework/network/grs/c/e;)Ljava/util/LinkedHashMap;
    ...
    check-cast v1, Lcom/huawei/hms/framework/network/grs/c/e;

    invoke-static {v1}, Lcom/huawei/hms/framework/network/grs/c/g;->a(Lcom/huawei/hms/framework/network/grs/c/e;)Ljava/util/LinkedHashMap;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/huawei/hms/framework/common/hianalytics/HianalyticsBaseData;->put(Ljava/util/LinkedHashMap;)Lcom/huawei/hms/framework/common/hianalytics/HianalyticsBaseData;

    iget-object v2, p0, Lcom/huawei/hms/framework/network/grs/c/f;->c:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/huawei/hms/framework/network/grs/c/f;->d:Lorg/json/JSONArray;
    ...
    :cond_3
    iget-object v1, p0, Lcom/huawei/hms/framework/network/grs/c/f;->d:Lorg/json/JSONArray;
